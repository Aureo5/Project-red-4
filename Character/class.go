...
func Class(nom string) Character {
	...
	for {
		fmt.Println("\n===Choisis ta classe=== ")
		fmt.Println("\n1. Éclaireur - Vie : 80 / Force : 15 / Initiative : 75% ")
		...
		fmt.Println("\n2. Soldat - Vie  : 100 / Force : 20 / Initiative : 50%")
		...
		fmt.Println("\n3. Médecin - Vie  : 120 / Force : 15 / Initiative : 50%")
		...
		switch choice {
		case "1":
			perso := Character{Name: nom, Health: 80, Initiative: 75, Nameclass: "eclaireur", Strength: 15, Or: 100, Equipment: []Equipment.Equipment{Equipment.Basicsword, Equipment.Basicpropulsor, Equipment.Grappling}}
			perso.Displayinfo()
			return perso
		case "2":
			perso := Character{Name: nom, Health: 100, Initiative: 50, Nameclass: "soldat", Strength: 20, Or: 100, Equipment: []Equipment.Equipment{Equipment.Basicsword, Equipment.Basicpropulsor, Equipment.Grappling}}
			perso.Displayinfo()
			return perso
		case "3":
			perso := Character{Name: nom, Health: 120, Initiative: 50, Nameclass: "medic", Strength: 15, Or: 100, Equipment: []Equipment.Equipment{Equipment.Basicsword, Equipment.Basicpropulsor, Equipment.Grappling}}
			perso.Displayinfo()
			return perso
		default:
