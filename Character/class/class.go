...
func Class(nom string) char.Character {
	...
	for {
		...
		case "1":
			...
			equip.Equip(&perso, "lame", Equipment.Basicsword)
			equip.Equip(&perso, "grappin", Equipment.Grappling)
			equip.Equip(&perso, "propulseur", Equipment.Basicpropulsor)
